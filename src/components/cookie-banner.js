      ...
      <div className={classes}>
        <div className="formidaCookie-container">
          <p className="formidaCookie-content">
            ...
            <a href="formidable.com/privacy-policy/#cookie-policy">Cookie Policy</a> and{" "}
            <a href="formidable.com/privacy-policy">Privacy Policy</a>. Your use of Formidable’s
            Products & Services, including our Open Source Software, is subject to these policies
            and terms.
          </p>
